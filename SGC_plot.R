...
################################################################################# plot_extension
SGC_plot_extension = function(pl, xname, yname, tit,
...
################################################################################# plot_pca
SGC_plot_pca = function(m, clusLabs, title = "PCA plot", ps = .5){
  ...
  plt_trans = SGC_plot_extension(plt_trans,
...
################################################################################# plot_silhouette
SGC_plot_silhouette = function(df, tit = "Gene Silhouette Index",
  ...
  plt_sil = SGC_plot_extension(plt_sil,
...
################################################################################# plot_heatMap
SGC_plot_heatMap = function(m, tit = "Adjacency Heatmap",
...
################################################################################# plot_conductance
SGC_plot_conductance = function(conduct, tit = "Clustering Conductance Index",
  ...
  plt_conduct = SGC_plot_extension(plt_conduct,
                             xname = xname, yname = yname,
                             tit = tit,
...
################################################################################# plot_density
SGC_plot_density = function(df, tit = "p-values Density",
...
################################################################################# plot_jitter
SGC_plot_jitter = function(df, tit = "p-values Distribution",
  ...
  plt_jitter = SGC_plot_extension(plt_jitter,
...
################################################################################# plot_mean
SGC_plot_bar = function(df, tit = "mean -log10 p-values",
                       xname = "module", yname = "-log10 p-value"){
  ...
  plt_mean = SGC_plot_extension(plt_mean,
                                xname = xname, yname = yname,
                                tit = tit,
                                xtextsize = 0, xtextface = "bold", xangle = 360,
                                xtitlesize = 0, xtitleface = "bold",
...
################################################################################# piechart
SGC_plot_pie = function(df, tit = "GO Analysis",
...
################################################################################# plot2excel
SGC_plot2excel = function(pl, wb, shname,
...
#################################################################################
SGC_saveResult = function(wb, xlsxName){
