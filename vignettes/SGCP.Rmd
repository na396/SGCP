...
## `SGCP` installation
To install the package `SGCP` use the following. For more information please visit [here](https://github.com/na396/SGCP)). `SGCP` relies on two more packages; `SummarizedExperiment` and `org.Hs.eg.db`.
